export default {
  ...
  "about": {
    "title": "について",
    "mission": "誰もが美しく、安全で、手頃な価格の住宅に住む機会を確保し、安全な未来とより良い生活を築くことができるようにします。",
    "why": "私たちは、誰もが安全で手頃な住居に住む権利があると信じています。",
    "how": "これを可能にする最善の方法は、摩擦を減らし、多様な文化的背景を持つ人々を結びつけ、彼らが自分の直接の文化圏や慣れ親しんだ環境以外の場所で生活することがどのようなものかを探究できるようにすることです。"
  },
  "sell": {
    "sell-flow": {
      "title": "不動産を売る",
