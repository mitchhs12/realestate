export default {
  ...
  "about": {
    "title": "Oko",
    "mission": "Osigurati da svi imaju priliku živjeti u lijepom, sigurnom i pristupačnom domu, osnažujući ih da izgrade sigurnu budućnost i bolji život.",
    "why": "Vjerujemo da svatko ima pravo na sigurno i pristupačno mjesto za život.",
    "how": "Najbolji način da se to učini je smanjenje trvenja i povezivanje ljudi iz različitih kulturnih sredina; omogućujući im da istraže kako je to živjeti na mjestima izvan njihove neposredne kulturne sfere i poznatog okruženja."
  },
  "sell": {
    "sell-flow": {
    ...
    "checkout": {
      ...
      "standard": {
        "title": "Standard",
        "subtitle": "Popis s osnovnim značajkama",
        "price": "Besplatno!",
        "perks": {
          "0": {
            "title": "Standardni popis",
            "subtitle": "Vaša nekretnina bit će navedena s osnovnom vidljivošću."
          },
          "1": {
          ...
          "2": {
            "title": "Ograničene fotografije",
            "subtitle": "Učitajte do 5 fotografija."
          }
        }
      }
    },
