export default {
  ...
  "billing": {
    "sellerModeSelection": {
      "title": "您是買家還是買家？",
      "subtitle": "您可以稍后在帐户设置中更改此设置。"
    },
    "lockedLoginMessage": "请登录查看价格。",
    "subText": {
      "six-months-free": "6 个月以上免费",
      "per-month": "每月"
    },
    "monthly": "每月",
    "yearly": "每年：（6 个月以上免费）",
    "change-account": "更改账户模式 ↗",
    "current-plan": "当前计划",
    "change-plan": "升级计划",
    "billed-annually": "每年计费",
    "subscribe": "订阅",
    "most-popular": "最受欢迎",
    "view-monthly-billing": "查看每月账单 ↗",
    "save-with-yearly": "每年节省",
    "six-months-free": "（6 个月以上免费↗）",
    "lowest-prices": "最低价格保证",
    "title": "计划和定价",
    "buyer": "买方",
    "seller": "卖方",
    "free": {
  ...
  "home": {
    ...
    "popular-sub": "我们客户的最爱",
    "locations": "热门地点",
    "locations-sub": "探索拉丁美洲",
    "cheapest": "最便宜的",
    "cheapest-sub": "无与伦比的价格，惊人的价值",
    "newest": "最新上市房产",
    "newest-sub": "查看我们的新品",
    "spotlight": "我们为您精选",
    "spotlight-sub": "焦点",
  ...
  "about": {
    "title": "关于",
    "content": {
      "h1": "欢迎来到 Viva Ideal：您的全球房地产门户",
      "p1": {
        "title": "助您畅享全球国际地产",
        "content": "Viva Ideal 的使命是成为全球寻求购买海外房产人士的首选平台。我们致力于帮助人们解决在国外购买房地产的复杂性，让跨境房产所有权变得无缝且人人可得。"
      },
      "p2": {
        "title": "您在交易过程中值得信赖的合作伙伴",
        "content": "我们明白，在国外购买房产需要应对陌生的法律和监管环境。Viva Ideal 凭借对每个经营所在国家当地法律的深入了解，在交易过程的每一步提供实际指导，从而脱颖而出。凭借我们的专业知识，您可以对房产购买的每个阶段都充满信心，从法律合规到金融交易，以及了解当地房地产市场。"
      },
      "p3": {
        "title": "专为现代买家设计",
        "content": "我们的平台特别适合寻求适合灵活、不受地点限制的生活方式的房产机会的数字游民、远程工作者和具有全球意识的个人。无论您是想投资、搬迁还是寻找远程工作的新基地，Viva Ideal 都能为您提供适合您独特需求和生活方式偏好的房产。"
      },
      "p4": {
        "title": "Viva Ideal 有何不同？",
        "content": "我们的平台不仅限于房产列表，还重点关注：",
        "b1": {
          "title": "本地化专业知识",
          "content": "详细了解每个地区购买的法律、财务和文化细节，以便您可以自信地完成整个过程。"
        },
        "b2": {
          "title": "全面支持",
          "content": "协助交易的每一步，确保您无论身在何处都能安全顺利地完成交易。"
        },
        "b3": {
          "title": "全球网络",
          "content": "接触值得信赖的房地产专业人士、法律顾问和当地专家，他们了解国际房地产所有权的挑战和机遇。"
        },
        "b4": {
          "title": "市场趋势",
          "content": "针对全球受众提供有关新兴市场和投资机会的最新信息。"
        },
        "b5": {
          "title": "社区亮点",
          "content": "每个地区的社区、生活方式和当地景点的详细资料，帮助您找到下一个房产的最佳位置。"
        }
      },
      "p5": {
        "title": "从拉丁美洲开始，拓展至全球",
        "content": "我们的旅程始于专注于充满活力的高增长拉丁美洲市场，这是经济实惠且极具吸引力的房地产投资的理想地区。随着时间的推移，我们计划将业务范围扩大到亚洲和欧洲，打造一个真正全球性的平台，满足世界各地国际买家的需求。"
      },
      "p6": {
        "title": "参与全球房地产的未来",
        "content": "随着远程工作改变了我们的生活和投资方式，Viva Ideal 将帮助您在世界任何地方找到理想的房产。欢迎来到 Viva Ideal，国际房产所有权从这里开始。"
      }
    },
    "mission": {
      "title": "我们的使命",
      "content": "确保每个人都有机会居住在美丽、安全且负担得起的家园，使他们能够建设安全的未来和更美好的生活。"
    },
    "why": {
      "title": "我们的理由",
      "content": "我们相信每个人都有权利享有一个安全且负担得起的居住环境。"
    },
    "how": {
      "title": "我们如何",
      "content": "实现这一目标的最佳方式是减少摩擦，让来自不同文化背景的人们联系起来；让他们探索在他们所处的文化圈和熟悉环境之外的地方生活是什么样的。"
    },
    "latam": {
      "title": "为什么选择拉丁美洲",
      "content": {
        "1": "拉丁美洲不仅仅是一个目的地，更是一处等待您去探索的家园。该地区拥有充满活力的文化、令人惊叹的风景和热情好客的社区，总能让您感到宾至如归。对于远程工作者和梦想家来说，这里提供了难得的机会：既能过上美好而又经济实惠的生活，又不会牺牲生活质量。在这里，您的收入可以得到进一步提高，让您将愿望变成现实，同时沉浸在丰富多彩的世界中。",
        "2": "拉丁美洲的真正特别之处在于它与人民和机遇的联系。该地区与美国时区一致，使合作变得无缝衔接，而远程工作的兴起正在推动当地发展并赋予社区权力。这是一个冒险与可能性相遇的地方——一个不仅可以创造生活，而且可以创造值得过的生活的地方。在 Viva Ideal，我们相信拉丁美洲是梦想与现实交汇的地方，我们在这里帮助您在其中找到完美的位置。"
      }
    },
    "brochures": "宣传册"
  },
  "sell": {
    "lockedLoginMessage": "请登录来出售房产。",
    "sell-flow": {
      "title": "出售新房产",
    ...
    "capacity": {
      ...
      "subtitle": "您的房产面积有多大？",
      "size": "在此输入您的房产面积。",
      "m-placeholder": "面积（平方米）...",
      "ft-placeholder": "尺寸（平方英尺）...",
      "change-to-feet": "更改为 ft²",
      "change-to-metres": "更改为m²",
      "units": {
        "m": "米",
        "ft": "英尺"
      },
    ...
    "contact": {
      ...
      "name": "姓名：",
      "name-placeholder": "输入业主姓名...",
      "email": "电子邮件：",
      "email-placeholder": "输入业主的电子邮件...",
      "mobile": "移动的：",
      "mobile-check": "设置为我的电话号码",
      "mobile-placeholder": "输入业主手机号...",
      "no-country": "未找到任何国家。",
      "search-country": "搜索国家..."
    },
    "description": {
    ...
    "step2": {
      "step": "第 2 步。",
      "title": "使其脱颖而出",
      "subtitle": "上传 5 张或更多照片、标题和描述。"
    },
    "step3": {
      "step": "步骤3.",
      "title": "完成并发布",
      "subtitle": "添加联系方式、价格并发布。"
    },
    "title": {
      "title": "标题",
      "subtitle": "为您的房产列表添加标题。",
      "warning": "请使用较小的标题。"
    },
    "type": {
      "title": "类型",
      "subtitle": "哪一个最能描述您的房产？",
      "options": {
        "0": "房子",
        "1": "公寓",
        "2": "舱",
  ...
  "my-properties": {
    ...
    "favorites": "收藏夹",
    "views": "视图",
    "properties-description": "您列出的房产总数。",
    "favorites-description": "您的房产被收藏的总次数。",
    "views-description": "您的房产被浏览的总次数。",
    "order-by": "排序依据",
    "date": "创建日期",
    "favorited": "最受喜爱",
    "price": "最昂贵的",
  ...
  "my-lists": {
    "title": "我的愿望清单",
    "warning": "您确定要删除该愿望清单吗？",
    "action": "此操作无法撤消。",
    "delete": "删除",
    "cancel": "取消",
    "no-properties": "尚未添加任何属性到此列表。",
    "modalTitle": "现有愿望清单",
    "subtitle": "将此房产保存至您现有的愿望清单之一。",
    "create": "创造",
    "back": "后退",
    "manage": "管理",
    "createTitle": "创建新列表",
    "createSubtitle": "将此属性保存至新列表。",
    "name": "新列表名称",
    "placeholder": "收藏夹",
    "createButton": "添加到新列表！",
  ...
  "settings": {
    ...
    "billing": {
      ...
      "account-type": "帐户类型",
      "account-type-description": "您当前的账户类型（您是买家还是卖家）。",
      "change-to-buyer": "切换到买家",
      "change-to-seller": "切换到卖家",
      "buyer": "买方",
      "seller": "卖方"
    },
    "submit": "节省"
