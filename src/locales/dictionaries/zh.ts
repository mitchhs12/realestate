export default {
  ...
  "about": {
    ...
    "content": {
      "0": "我们的旅程始于一个简单的想法",
      "1": "如果在国外找房子能像在附近买房子一样简单那该有多好？",
      "2": "从打破语言障碍到熟悉外国法律和货币，我们看到了简化流程、使国际购房变得容易的机会。",
      "3": "我是 Viva Ideal 的创始人米切尔，但这不仅仅是我的故事，这也是一个充满激情的团队的共同愿景。",
      "4": "我们共同构建的不仅仅是一个平台；我们还创建一个将人们与家园、文化和跨国界机遇联系起来的社区，我们致力于将这个梦想变成现实。",
