export default {
  ...
  "about": {
    "title": "에 대한",
    "mission": "모든 사람이 아름답고 안전하며 저렴한 집에서 살 수 있는 기회를 보장하고, 안전한 미래와 더 나은 삶을 구축할 수 있는 역량을 강화합니다.",
    "why": "우리는 모든 사람이 안전하고 저렴한 주거공간을 누릴 권리가 있다고 믿습니다.",
    "how": "이를 실현하는 가장 좋은 방법은 마찰을 줄이고 다양한 문화적 배경을 가진 사람들을 연결하는 것입니다. 이를 통해 그들이 익숙한 환경과 직접적인 문화적 영역 밖의 장소에서 사는 것이 어떤 것인지 탐험할 수 있도록 돕습니다."
  },
  "sell": {
    "sell-flow": {
