export default {
  "home": {
    "header": {
      ...
      "construction-sub": "Veuillez créer un compte et nous vous enverrons un e-mail dès qu'il sera prêt.",
      "sell-button-big": "Vendez votre propriété",
    ...
    "cities": "Quartiers recommandés de la ville",
