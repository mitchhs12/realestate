export default {
  ...
  "home": {
    "about": {
      "sub": "HAKKIMIZDA",
      "title": "İyi ellerdesiniz",
      "body": "Viva Ideal'de, herkesin güvenli ve uygun fiyatlı bir yaşam alanına sahip olma hakkı olduğuna inanıyoruz. Yabancı alıcıların ihtiyaçlarını karşılamak üzere tasarlanmış, ilk gerçek uluslararası gayrimenkul platformu olmaktan gurur duyuyoruz.",
      "faq": "SSS",
      "our-team": "Ekibimiz",
      "contact": "Bize Ulaşın"
    },
  ...
  "articles": {
    "latestArticles": {
      "title": "Son Makaleler ve Bloglar",
      "sub": "TREND OLANLAR",
  ...
  "about": {
    "main": {
      "title": "Hikayemiz",
      "sub": "BÜYÜK BİR YOLCULUK"
    },
    "team": {
      "title": "Ekibimiz",
      "sub": "ÖNEMSEYEN BİR EKİP"
    },
    "contact": "Temas etmek",
    "values": {
      "title": "Değerlerimiz",
    ...
    "content": {
      "0": "Yolculuğumuz basit bir fikirle başladı",
      "1": "Peki ya yurtdışında bir ev bulmak, yakınlarda bir ev satın almak kadar kolay olsaydı?",
      "2": "Dil engellerini aşmaktan yabancı yasalar ve para birimleri arasında geçiş yapmaya kadar, süreci basitleştirme ve uluslararası ev satın almayı erişilebilir kılma fırsatı gördük.",
      "3": "Ben Viva Ideal'in kurucusu Mitchell'ım, ancak bu sadece benim hikayem değil; tutkulu bir ekibin ortak vizyonu.",
      "4": "Birlikte, bir platformdan daha fazlasını inşa ediyoruz; insanları evlere, kültürlere ve sınırların ötesindeki fırsatlara bağlayan, bu rüyayı gerçeğe dönüştürme taahhüdümüzle hareket eden bir topluluk yaratıyoruz.",
    ...
    "how": {
      "title": "Bizim Nasıl",
      "content": "Sürtüşmeleri azaltarak ve farklı kültürel geçmişlere sahip insanları birbirine bağlayarak; bilindik çevrelerin ötesinde keşiflere olanak sağlamak."
    },
    "latam": {
      "title": "Neden Latin Amerika",
      "sub": "AVANTAJLARLA DOLU BİR KITA",
      "content": {
        "1": {
          "title": "Uzaktan Çalışma Patlaması",
          "body": "Küresel ölçekte artan uzaktan çalışma, üretkenliği ve fırsatları artırıyor."
        },
        "2": {
          "title": "Gelir Tasarrufları",
          "body": "Latin Amerika'da düşük yaşam maliyetleri uzaktan çalışanları cezbediyor."
        },
        "3": {
          "title": "ABD Saat Dilimleri",
          "body": "ABD saat dilimleriyle uyum, uzaktan işbirliğini kolaylaştırır."
        },
        "4": {
          "title": "Yaşam Maliyeti Avantajı",
          "body": "Uygun fiyatlı yaşam, yüksek gelirli profesyonelleri cezbediyor."
        },
        "5": {
          "title": "Ekonomik Yükseliş",
          "body": "Uzaktan çalışan akını yerel refahı ve ekonomik büyümeyi artırıyor."
        }
      }
    },
    "brochures": {
      "title": "Broşürler",
      "sub": "BİZİ DAHA FAZLA KEŞFEDİN!"
    }
  },
  "sell": {
