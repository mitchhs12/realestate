export default {
  ...
  "about": {
    ...
    "content": {
      "0": "Peki ya yurtdışında bir ev bulmak, yakınlarda bir ev satın almak kadar kolay olsaydı?",
      "1": "Dil engellerini aşmaktan yabancı yasalar ve para birimleri arasında geçiş yapmaya kadar, süreci basitleştirme ve uluslararası ev satın almayı erişilebilir kılma fırsatı gördük.",
      "2": "Merhaba, ben Viva Ideal'in kurucusu Mitchell. Bu sadece benim hikayem değil; tutkulu bir ekibin ortak vizyonu. Birlikte, bir platformdan daha fazlasını inşa ediyoruz; insanları evlere, kültürlere ve sınırların ötesindeki fırsatlara bağlayan bir topluluk yaratıyoruz; bu rüyayı gerçeğe dönüştürme taahhüdümüzle hareket ediyoruz.",
      "3": "Merhaba, ben Viva Ideal'in kurucusu Mitchell. Bu sadece benim hikayem değil; tutkulu bir ekibin ortak vizyonu. Birlikte, bir platformdan daha fazlasını inşa ediyoruz; insanları evlere, kültürlere ve sınırların ötesindeki fırsatlara bağlayan bir topluluk yaratıyoruz; bu rüyayı gerçeğe dönüştürme taahhüdümüzle hareket ediyoruz.",
      "4": "Bu sadece benim hikayem değil; tutkulu bir ekibin ortak vizyonu.",
