...
export default function SearchBox({
  ...
  const { query, setQuery, clickedLocation, setClickedLocation } =
  ...
  const handleSearch = useCallback(
    ...
    [isSmallMap, router, setQuery, setSearchResult]
  );
      ...
      >
        <div className="flex w-full items-center">
          {pathname !== "/sell/location" &&
            pathname !== `${defaultLanguage}/sell/location` &&
            !rawBox && (
              ...
              <div className="flex justify-center items-center w-full rounded-full">
                <div className="relative w-full flex justify-center items-center">
                  ...
                  <Input
                    ...
                    type="search"
                    placeholder={
                      pathname !== "/" && pathname !== `/${defaultLanguage}`
                        ? placeholderShort
                        : ""
                    }
                    className={`${
                      ...
                      pathname === `${defaultLanguage}/sell/location`
                        ...
                        ? "rounded-md"
                        : "rounded-none"
                    } bg-popover pl-11 overflow-hidden whitespace-nowrap text-ellipsis`} // Add padding-left to create space for the icon
                    value={query}
                    onFocus={getGeolocation}
                    onMouseDown={() =>
                      results.length > 0 && query && setPopoverOpen(true)
                    }
                    onChange={(e) => {
              ...
              <div>
                <PopoverContent
                  ...
                  className={`${
                    ...
                    pathname.startsWith(`/${defaultLanguage}/search`)
                      ? rawBox
                        ? "flex"
                        : "hidden xs:flex"
                      : "flex"
                  } flex-col PopoverContent rounded-b-3xl ${
                    (pathname === "/sell/location" ||
                      pathname === `/${defaultLanguage}/sell/location`) &&
                    "rounded-3xl lg:rounded-r-none lg:rounded-b-3xl"
                  }`}
                >
                          ...
                          index === 0
                            ...
                            : index === results.length - 1 &&
                              ...
                              pathname === `/${defaultLanguage}/sell/location`
                                ? "rounded-bl-2xl"
                                : "rounded-b-2xl")
                        } py-1 md:py-2 cursor-pointer hover:bg-muted`}
                        onClick={() => {
